function [P,F,i,z,fz] = metI3p4(fun,P,F,i,a,b,u,fa,fb,fu,e)
...
fv = fun(v); i = i + 1; P(i) = v; F(i) = fv;
z = v; fz = fv;
displ([i2s5(i) r2s10(h) r2s10(fv) r2s10(v)])
...
while abs(h) > e % Цикл метода
    ...
    i = i + 1; P(i) = w; F(i) = fw;
    z = w; fz = fw;
    displ([i2s5(i)  r2s10(h) r2s10(fw) r2s10(w)])
